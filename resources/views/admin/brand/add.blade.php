...
<body>
    <div id="pageAll">
        ...
        <form action="{{route('add_do')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="page ">
            ...
            <div class="banneradd bor">
                ...
                <div class="baBody">
                    ...
                    <div class="bbD">
                        是否显示：<label><input type="radio" checked="checked" value="1" name="brand_show" />是</label> <label><input
                            type="radio" value="2" name="brand_show" />否</label>
                    </div>
                    <div class="bbD">
                        <p class="bbDP">
