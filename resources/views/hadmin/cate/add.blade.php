...
@section('content')
    <form style="margin-top:50px;" action="{{url('hadmin/cate/add_do')}}" method="post">
          <div class="form-group">
            <label for="exampleInputEmail1">分类名称</label>
            <input type="text" name="cate_name" class="form-control cate_name" id="exampleInputEmail1" placeholder="分类名称" style="height:50px;"><b class="b"></b>
          </div>
          <div class="form-group">
