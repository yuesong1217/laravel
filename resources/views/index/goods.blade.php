  ...
  <form action="">
    ...
    <div class="maincont">
     ...
     <div id="sliderA" class="slider">
      <img src="http://www.laupload.com/{{$data->goods_img}}" />
      <img src="http://www.laupload.com/{{$data->goods_img}}" />
      <img src="http://www.laupload.com/{{$data->goods_img}}" />
      <img src="http://www.laupload.com/{{$data->goods_img}}" />
      <img src="http://www.laupload.com/{{$data->goods_img}}" />
     ...
     <table class="jia-len">
      <tr>
       <th><strong class="orange">{{$data->goods_sprice}}元</strong></th>
       <td>
     ...
     <div class="proinfoList">
      <img src="http://www.laupload.com/{{$data->goods_img}}" width="636" height="822" />
     </div><!--proinfoList/-->
     <div class="proinfoList">
      暂无信息....
     </div><!--proinfoList/-->
     ...
     <table class="jrgwc">
      <tr>
       ...
       <td><a href="javascript:;" class="putcar">加入购物车</a></td>
      </tr>
     </table>
    </div><!--maincont-->
